        ...
        >
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              {emailChecked && (
                <p className="text-xs text-[var(--point)]">사용 가능한 이메일이에요.</p>
              )}
              {checkEmailMutation.data && checkEmailMutation.data.error !== 0 && (
                <p className="text-xs text-red-500">{checkEmailMutation.data.message}</p>
              )}
            </div>
