            ...
            >
              <GlassCard className="p-6">
                ...
                <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                  <NutritionItem label="칼로리" value={`${nutrition.calories} kcal`} />
                  <NutritionItem
                    label="탄수화물"
                    value={`${nutrition.carbohydrates}g`}
                  />
                  <NutritionItem label="단백질" value={`${nutrition.protein}g`} />
...
function NutritionItem({
  ...
  return (
    <div className="rounded-lg border border-[var(--glass-border)] bg-white/50 px-4 py-3 text-center">
      ...
      <p className="mt-0.5 font-display font-semibold text-[var(--foreground)]">
        {value}
      </p>
    </div>
  );
